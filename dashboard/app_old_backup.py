...
try:
    from dashboard.pages import (
        ...
        factor_analysis as factor_page,
...
# ============================================================================
# NEW PAGES - Route to individual page modules
# ============================================================================

# Check if page is one of the new pages
if pages_available and page in ["Single Stock Analysis", "Portfolio from Galaxy",
                                  "Portfolio from Single Stock", "Portfolio Risk Analysis",
                                  "Factor Analysis", "Advanced Monte Carlo", "Security Pricing"]:
...
# ============================================================================
# OLD PAGES - Keep existing functionality
# ============================================================================

elif page == "Portfolio Builder (Old)":
